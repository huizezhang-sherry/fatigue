...
```{r}
ausopen %>% filter(GameNo == 1, match_num == 1112, SetNo ==1) %>% select(ElapsedTime, P1GamesWon, P2GamesWon, P1Score, P2Score, Speed_KMH, ServeIndicator, GameNo, SetNo) 

ausopen %>% filter(GameNo == 2, match_num == 1112, SetNo ==1) %>% select(ElapsedTime, P1GamesWon, P2GamesWon, P1Score, P2Score, Speed_KMH, ServeIndicator, GameNo, SetNo) 
```
